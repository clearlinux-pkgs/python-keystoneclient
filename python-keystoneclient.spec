...
Version  : 1.8.0
Release  : 23
URL      : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-1.8.0.tar.gz
Source0  : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-1.8.0.tar.gz
...
%prep
%setup -q -n python-keystoneclient-1.8.0
%patch1 -p1
