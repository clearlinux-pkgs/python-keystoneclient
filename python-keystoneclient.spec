...
Source99 : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-3.6.0.tar.gz.asc
...
%prep
%setup -q -n python-keystoneclient-3.6.0
%patch2 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487900953
