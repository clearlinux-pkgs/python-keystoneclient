...
Version  : 2.1.1
Release  : 29
URL      : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-2.1.1.tar.gz
Source0  : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-2.1.1.tar.gz
...
%prep
%setup -q -n python-keystoneclient-2.1.1
