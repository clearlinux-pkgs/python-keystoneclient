...
Version  : 2.0.0
Release  : 28
URL      : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-2.0.0.tar.gz
Source0  : http://tarballs.openstack.org/python-keystoneclient/python-keystoneclient-2.0.0.tar.gz
...
%prep
%setup -q -n python-keystoneclient-2.0.0
